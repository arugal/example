...
public class WindowJoin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final long rate = params.getLong("rate", 1);
        ...
        DataStream<Tuple2<String, Integer>> grades = WindowJoinSampleData.GradeClass.getSource(env, rate);
    ...
    private static class NameKeySelector implements KeySelector<Tuple2<String, Integer>, String> {
        ...
        private static final long serialVersionUID = -6843427212956124586L;
